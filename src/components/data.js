...
export const projectData = [
    ...
    },
    {
        ...
        logo: "NEXEN TIRE",
        type: "Project 2 반응형 웹사이트",
        title: "NEXENTIRE Web Site",
        info: [ '처음 코딩을 배우고 완성해본 홈페이지로 애착이 가는',
        '넥센 타이어 리디자인 웹 표준 사이트입니다.',
        '동적인 슬라이드 배너, 동영상 슬라이드, 탭메뉴를 구현해보았으며',
        '이미지 호버 이벤트, navi menu 이벤트 스킬 등을 습득하였습니다.'],
        useStack: "HTML / CSS / Javascript / JQuery",
    ...
    },
    {
        ...
        "기능을 구현하였으며 Redux 상품 관리와 함께 메인페이지의 카테고리 별로 추천",
